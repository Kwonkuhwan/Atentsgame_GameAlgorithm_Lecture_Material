...
{
    public Image[] digitImage = null;       // 자리별로 사용할 Image UI, 0번째가 1자리, 1번째가 10자리, 2번째가 100자리, 3번째가 1000자리
    ...
    public int Number
    {
        ...
        {
            number = value;
            number = Mathf.Clamp(number, 0, 9999);          // 4자리까지만 표현 가능하니깐 최대값은 9999로 설정
